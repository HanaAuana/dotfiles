...
export ZSH=/Users/michaellim/.oh-my-zsh
...
# Clear symfony cache alias
alias wfclearsymcacheprod='rm -rf docker/data/wufoo/sf2/cache/prod/*'
alias wfclearsymcacheloc= 'rm -rf docker/data/wufoo/sf2/cache/loc/*'
